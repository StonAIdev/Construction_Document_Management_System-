...
export default function CreateEnterpriseStepThree({ projectData, handleNext, enterpriseData }) {
            ...
            <Formik
              ...
              onSubmit={async (values) => {
                try {
                  ...
                  values.enterprise_id = enterpriseData.current.enterprise_id;
                  values.user_id = 5;
                  projectData.current = values;
                  handleNext();
                } catch (error) {
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ py: 2 }}>
                        <Button
                          ...
                          variant="contained"
                          disabled={!(values && values.project_name)}
                        >
                          Next
                        </Button>
                      </Box>
