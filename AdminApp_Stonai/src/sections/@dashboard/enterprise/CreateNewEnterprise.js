...
import CreateEnterpriseStepOne from './CreateEnterpriseStepOne';

import CreateProjectStepThree from './CreateProjectStepThree';

const steps = [' Enterprise', 'Users'];
export default function CreateNewEnterprise() {
  ...
  const [newEnterprise, setnewEnterprise] = React.useState('');
  ...
  const handleNext = () => {
    console.log('activeStephanlde', activeStep);
  ...
  function getStepperForm() {
    ...
    if (activeStep === 0) {
      form = (
        <CreateEnterpriseStepOne
          enterpriseData={enterpriseData}
          // setEnterpriseData={setEnterpriseData}
          handleNext={handleNext}
          setnewEnterprise={setnewEnterprise}
        />
      );
