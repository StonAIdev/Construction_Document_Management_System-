...
import MaterialInspectionTemplate from "../components/CoverPage/MaterialInspectionTemplate";
...
const CoverPageMeterialInspectionRequest = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <MaterialInspectionTemplate values={values} />
      ).toBlob();
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <OutlinedInput
                                        ...
                                        size="small"
                                        sx={{ width: "100%" }}
                                        name="Material_Approval_ref"
                                        value={values.Material_Approval_ref}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                      ></OutlinedInput>
                                    </Grid>
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <Heading1
                                        ...
                                        className="my-1"
                                      >
                                        Description of Supplied Material
                                      </Heading1>
                                    </Grid>
                                    <Divider
                                      orientation="vertical"
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <OutlinedInput
                                        ...
                                        margin="small"
                                        name="Description_of_Supplied_Material"
                                        value={
                                          values.Description_of_Supplied_Material
                                        }
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <Heading1
                                        ...
                                        className="my-1"
                                      >
                                        Invoice No./ Delivery No./ Shopment
                                      </Heading1>
                                    </Grid>
                                ...
                                >
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <FormControl
                                        component="fieldset"
                                        className="d-flex justify-content-end align-items-center  w-auto"
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <Heading1
                                        ...
                                        className="my-1"
                                      >
                                        Details Given Above Correct? (Type,
                                        Size, Wt, Qty, etc)
                                      </Heading1>
                                    </Grid>
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <Heading1
                                        ...
                                        className="my-1"
                                      >
                                        Compliance certificate/ Test Certificate
                                      </Heading1>
                                    </Grid>
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <Heading1
                                        ...
                                        className="my-1"
                                      >
                                        Confirm with Approval Submittal / Smaple
                                      </Heading1>
                                    </Grid>
...
export default CoverPageMeterialInspectionRequest;
