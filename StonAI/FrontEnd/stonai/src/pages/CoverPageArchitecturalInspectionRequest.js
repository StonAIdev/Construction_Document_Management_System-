...
import ArchitecturalInspectionTemplate from "../components/CoverPage/ArchitecturalInspectionTemplate";
...
const CoverPageArchitecturalInspectionRequest = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const [inspectionDate, setInspectionDate] = React.useState(null);
  ...
  const [seqlist, setseqlist] = useState([{ property: "" }]);
  const [seqOfWork, setsetSeqOfWork] = useState({
    id: null,
    disc: "",
    civil: "",
    mNP: "",
  ...
  const [seqOfWorkList, setSeqOfWorkList] = useState([
    { id: null, disc: "", civil: "", mNP: "", electrical: "", Elevator: "" },
  ]);
  ...
  const { Block, Plaster } = state;

  const handlerSaveSeqOfWork = (event) => {
    const length = seqOfWorkList.length + 1;
    setsetSeqOfWork({ ...seqOfWork, [event.target.name]: event.target.value });
  };
  const handlerSaveSeqOfWorkList = () => {
    const length = seqOfWorkList.length + 1;
    const seq = { ...seqOfWork, id: length };
    setSeqOfWorkList([...seqOfWorkList, seq]);
  };
  const AddseqRow = () => {
    setseqlist([...seqlist, { propertyname: "" }]);
  };
  const [SpecifyDisc, setSpecifyDisc] = useState(false);
  const [unecSelect, setunecSelect] = useState(false);
  const UnecHandler = (event) => {
    if (discipline === "other") {
      setunecSelect(true);
    } else {
      setunecSelect(false);
  ...
  const changeInspectionDateHandler = (newValue) => {
    if (newValue != "Invalid Date" && newValue != null) {
      var myDate = dateFormatChange(newValue);
      setInspectionDate(myDate);
    } else {
      setInspectionDate(null);
    }
  };
  const changeDeliveryDateHandler = (newValue) => {
    if (newValue != "Invalid Date" && newValue != null) {
      var myDate = dateFormatChange(newValue);
      setDeliveryDate(myDate);
    } else {
  ...
  const getCoverPageDetails = async (coverpage_id) => {
    ...
    try {
      ...
      setSeqOfWorkList(res.data._source.coverPage.seqOfWorkList);
      setInspectionDate(res.data._source.coverPage.inspection_date);
      setDeliveryDate(res.data._source.coverPage.delivery_date);
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <ArchitecturalInspectionTemplate values={values} />
      ).toBlob();
                        ...
                        <Formik
                          ...
                          onSubmit={async (values) => {
                            if (submitType === "save") {
                              ...
                              values.seqOfWorkList = seqOfWorkList;
                              values.inspection_date = inspectionDate;
                              ...
                              <Grid container spacing={1} xs={12} className="">
                                  ...
                                  <Grid xs={12} className="d-flex p-0 ">
                                    ...
                                    >
                                      <OutlinedInput
                                        fullWidth
                                        margin="small"
                                        name="Shop_Drawing_ref"
                                        value={values.Shop_Drawing_ref}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        className="textboxmui "
                                        size="small"
                                  ...
                                  <Grid xs={12} className="d-flex p-0">
                                    ...
                                    >
                                      <OutlinedInput
                                        fullWidth
                                        margin="small"
                                        name="Method_Statement_ref"
                                        value={values.Method_Statement_ref}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        className="textboxmui "
                                        size="small"
                                ...
                                >
                                  <Grid xs={12} className=" d-flex">
                                    ...
                                    <Grid className="w-100 m-1 d-flex align-items-center ">
                                      <OutlinedInput
                                        fullWidth
                                        name="Description"
                                ...
                                >
                                  ...
                                  >
                                    <IconButton className="">
                                      <Box
                                        onClick={handlerSaveSeqOfWorkList}
                                        sx={{
                                    ...
                                    <Grid xs={12} className=" d-flex">
                                      ...
                                      >
                                        <OutlinedInput
                                          ...
                                          label="clientt_signature"
                                          margin="small"
                                          name="client_signature"
                                          onBlur={handleBlur}
                                          onChange={handleChange}
                                          value={values.client_signature}
                                          className="textboxmui "
                                          size="small"
                                          sx={{ width: "100%" }}
                                        ></OutlinedInput>
                                        ...
                                        >
                                          <Stack spacing={2}>
                                            <DesktopDatePicker
                                              ...
                                              value={clientDate}
                                              sx={{ width: "100%" }}
                                              onChange={changeClientDateHandler}
                                              renderInput={(params) => (
                                                <TextField
                                                  className="textboxmui"
                                                  size="small"
                                  ...
                                  <Grid xs={12} className=" d-flex">
                                    ...
                                    >
                                      <OutlinedInput
                                        ...
                                        label="client_comments"
                                        margin="small"
                                        name="client_comments"
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={values.client_comments}
                                        className="textboxmui p-0"
                                        size="small"
                                        multiline
                                        maxRows={2}
...
export default CoverPageArchitecturalInspectionRequest;
