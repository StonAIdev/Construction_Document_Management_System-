...
import TechnicalSubmittalTemplate from "../components/CoverPage/TechnicalSubmittalTemplate";
...
const CoverPageMeterialInspectionRequest = ({
  ...
  const getLogoFromS3 = async (key, coverPage_id) => {
    console.log("keycoverPage_id", coverPage_id + key);
    try {
      const response = await axios(
        "https://g0ajndudsk.execute-api.ap-south-1.amazonaws.com/default/getPresignedURLGetObject?fileName=" +
          coverPage_id +
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <TechnicalSubmittalTemplate values={values} />
      ).toBlob();
                                ...
                                >
                                  ...
                                  >
                                    <Heading1
                                      ...
                                      className="my-1"
                                    >
                                      We are sending here with under separate
                                      cover
                                    </Heading1>
                                  </Grid>
                                    ...
                                    <FormControl component="fieldset">
                                      ...
                                      >
                                        ...
                                        <FormControlLabel
                                          ...
                                          control={
                                            <Checkbox
                                              checked={TemporaryWorksDoc}
                                              onChange={handleChangeCheckbox}
                                              name="TemporaryWorksDoc"
                                            />
                                          }
                                          label="Temporary Works Documentations"
                                        />
