...
import RequestForInfoTemplate from "../components/CoverPage/RequestForInfoTemplate";
...
const CoverPageRequestforInformation = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <RequestForInfoTemplate values={values} />
      ).toBlob();
                                ...
                                >
                                  ...
                                  >
                                    <Heading1
                                      ...
                                      className="my-1"
                                    >
                                      Information Required And/ Or Clarification
                                      Required
                                    </Heading1>
                                  </Grid>
...
export default CoverPageRequestforInformation;
