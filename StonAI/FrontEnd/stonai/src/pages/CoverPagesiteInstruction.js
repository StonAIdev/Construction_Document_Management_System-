...
import SiteinstructionTemplate from "../components/CoverPage/SiteinstructionTemplate";
...
const CoverPagesiteInstruction = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <SiteinstructionTemplate values={values} />
      ).toBlob();
                                    ...
                                    <Grid xs={12} className=" d-flex">
                                      ...
                                      >
                                        <OutlinedInput
                                          ...
                                          label=" "
                                          margin="small"
                                          name="COMPANY_DOC_CON"
                                          onBlur={handleBlur}
                                          onChange={handleChange}
                                          value={values.COMPANY_DOC_CON}
                                          className="textboxmui p-0"
                                          size="small"
                                          multiline
                                          maxRows={5}
...
export default CoverPagesiteInstruction;
