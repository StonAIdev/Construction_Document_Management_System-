...
import MaterialTemplate from "../components/CoverPage/MaterialTemplate";
...
const CoverPageMaterialSubmittal = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const [Enclosure, setEnclosure] = React.useState({
    ManufacturerDate: false,
    MSDS: false,
    TestReport: false,
    Licence: false,
    Certificates: false,
    PreviousApprovals: false,
    Methadology: false,
    Samples: false,
    ComplienceSceets: false,
...
export default CoverPageMaterialSubmittal;
