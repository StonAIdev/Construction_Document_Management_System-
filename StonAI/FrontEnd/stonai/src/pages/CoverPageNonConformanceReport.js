...
import NonConferenceRepTemplate from "../components/CoverPage/NonConferenceRepTemplate";
...
const CoverPageNonConformanceReport = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const { CSA, MEP, MED, Electrical, other } = state;
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <NonConferenceRepTemplate values={values} />
      ).toBlob();
                              ...
                              <Grid container spacing={1} xs={12} className="">
                                  ...
                                  <Grid container xs={12} className="">
                                    ...
                                    <Grid xs={12} className=" d-flex">
                                      ...
                                      <Grid
                                        item
                                        xs={9.4}
                                        className="m-1 d-flex align-items-center mx-auto"
                                      >
                                        <OutlinedInput
                                          error={Boolean(
                                ...
                                >
                                  <Grid item xs={12} className="d-flex">
                                    ...
                                    >
                                      <OutlinedInput
                                        error={Boolean(
                                          touched.Drawing_Reference &&
                                            errors.Drawing_Reference
                                        )}
                                        fullWidth
                                        helperText={
                                          touched.Drawing_Reference &&
                                    ...
                                    >
                                      <OutlinedInput
                                        error={Boolean(
                                          touched.BOQ_Reference &&
                                            errors.BOQ_Reference
                                        )}
                                        fullWidth
                                        helperText={
                                          touched.BOQ_Reference &&
                                  ...
                                  <Grid item xs={12} className="d-flex">
                                    ...
                                    >
                                      <OutlinedInput
                                        error={Boolean(
                                          touched.Specs_Reference &&
                                            errors.Specs_Reference
                                        )}
                                        fullWidth
                                        helperText={
                                          touched.Specs_Reference &&
                                        ...
                                        margin="small"
                                        name="Specs_Reference"
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={values.Specs_Reference}
                                        className="textboxmui p-0"
                                        size="small"
                                        multiline
                                        maxRows={2}
                                    ...
                                    >
                                      <OutlinedInput
                                        error={Boolean(
                                          touched.Method_Statement &&
                                            errors.Method_Statement
                                        )}
                                        fullWidth
                                        helperText={
                                          touched.Method_Statement &&
                                  ...
                                  <Grid item xs={12} className="d-flex">
                                    ...
                                    >
                                      <OutlinedInput
                                        error={Boolean(
                                          touched.Material_Submittal_Reference &&
                                            errors.Material_Submittal_Reference
                                        )}
                                        fullWidth
                                        helperText={
                                          touched.Material_Submittal_Reference &&
                                        ...
                                        margin="small"
                                        name="Material_Submittal_Reference"
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={
                                          values.Material_Submittal_Reference
                                        }
                                        className="textboxmui p-0"
                                        size="small"
                                        multiline
                                    ...
                                    >
                                      <OutlinedInput
                                        error={Boolean(
                                          touched.other_Reference &&
                                            errors.other_Reference
                                        )}
                                        fullWidth
                                        helperText={
                                          touched.other_Reference &&
                                ...
                                >
                                  ...
                                  >
                                    <OutlinedInput
                                      className="textboxmui p-0"
                                      name="Causes_of_Non_Conformance"
                                      onBlur={handleBlur}
                                      onChange={handleChange}
                                      value={values.Causes_of_Non_Conformance}
                                      multiline
                                      minRows={3}
                                      maxRows={8}
                                      sx={{ width: "100%" }}
                                ...
                                >
                                  ...
                                  >
                                    <Heading1
                                      ...
                                      className="my-1"
                                    >
                                      Non Conformance Close Out Comments
                                    </Heading1>
                                  </Grid>
                                  ...
                                  >
                                    <OutlinedInput
                                      className="textboxmui p-0"
                                      name="Non_Conformance_Close_Out_Comments"
                                      onBlur={handleBlur}
                                      onChange={handleChange}
                                      value={
                                        values.Non_Conformance_Close_Out_Comments
                                      }
                                      size="small"
                                      multiline
                                      minRows={3}
...
export default CoverPageNonConformanceReport;
