...
const CreateProject = ({ setUser, user, userInfo, setUserInfo }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Create Project | StonAi</title>
      </Helmet>
      <Box
        sx={{
      ...
      >
        ...
        >
          <Grid className="" container item xs={12} columnSpacing={2}>
            ...
            <Grid item xs={12}>
              <Divider fullWidth sx={{ backgroundColor: "grey" }}></Divider>
            </Grid>
            <Grid item xs={12}>
              <Formik
                initialValues={{
                  ...
                  <form onSubmit={handleSubmit}>
                    <Grid container spacing={1}>
                      ...
                      <Grid item xs={12} md={6}>
                        <TextField
                          error={Boolean(
                            touched.abbreviation_project &&
                              errors.abbreviation_project
                          )}
                          fullWidth
                          helperText={
                            touched.abbreviation_project &&
                          ...
                          margin="normal"
                          name="abbreviation_project"
                          onBlur={handleBlur}
                          onChange={handleChange}
                          value={values.abbreviation_project}
                          variant="outlined"
                          size="small"
                        />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <TextField
                          error={Boolean(
                            touched.abbreviation_contractor &&
                              errors.abbreviation_contractor
                          )}
                          fullWidth
                          helperText={
                            touched.abbreviation_contractor &&
                          ...
                          label="Contractor Abbriviation"
                          margin="normal"
                          name="abbreviation_contractor"
                          onBlur={handleBlur}
                          onChange={handleChange}
                          value={values.abbreviation_contractor}
                          variant="outlined"
                          size="small"
                        />
                      </Grid>
                      ...
                      <Grid item xs={12}>
                        <Typography
                          sx={{ fontSize: 18, marginBottom: "0px" }}
