...
import PreQualificationTemplate from "../components/CoverPage/PreQualificationTemplate";
...
const CoverPagePrequalificationSubmittal = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <PreQualificationTemplate values={values} />
      ).toBlob();
...
export default CoverPagePrequalificationSubmittal;
