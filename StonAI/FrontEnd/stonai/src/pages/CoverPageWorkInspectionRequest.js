...
import WorkInspectionTemplate from "../components/CoverPage/WorkInspectionTemplate";
...
const CoverPageWorkInspectionRequest = ({
  setUser,
  user,
  userInfo,
  setUserInfo,
  ...
  const margePdfs = async (values) => {
    try {
      ...
      const blob = await pdf(
        <WorkInspectionTemplate values={values} />
      ).toBlob();
...
export default CoverPageWorkInspectionRequest;
