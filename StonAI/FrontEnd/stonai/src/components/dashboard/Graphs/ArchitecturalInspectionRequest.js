...
import { Badge, TextField, IconButton, Stack, Button } from "@mui/material";
...
export const ArchitecturalInspectionRequest = ({
  ...
  const handleFilterClear = async () => {
    ...
    try {
      var res = await axios.post(
        url + "/Document/documentStatsArchitFilter",
        {
...
export default ArchitecturalInspectionRequest;
