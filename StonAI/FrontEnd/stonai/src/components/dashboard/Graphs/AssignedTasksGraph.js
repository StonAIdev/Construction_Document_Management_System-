...
export const AssignedTasksGraph = ({
  assignedTaskStats,
  project,
  user,
  setAssignedTasksStats,
}) => {
  const isEmpty = Object.values(assignedTaskStats).every(
    (x) => x === null || x === 0
  );
  ...
  const total =
    parseInt(assignedTaskStats.completed) +
    parseInt(assignedTaskStats.cancelled) +
    parseInt(assignedTaskStats.delayed) +
    parseInt(assignedTaskStats.inProcess);

  const data = [
    {
      name: "Completed",
      value: parseInt(assignedTaskStats.completed),
      color: "#1bad7b",
    },
    {
      name: "Cancelled",
      value: parseInt(assignedTaskStats.cancelled),
      color: "#ce0000",
    },
    {
      name: "Delayed",
      value: parseInt(assignedTaskStats.delayed),
      color: "#fe8b22",
    },
    {
      name: "In Process",
      value: parseInt(assignedTaskStats.inProcess),
    ...
    <>
      ...
      >
        <Stack direction="row">
          ...
          {(creatorForFilter && Object.keys(creatorForFilter).length > 0) ||
...
export default AssignedTasksGraph;
