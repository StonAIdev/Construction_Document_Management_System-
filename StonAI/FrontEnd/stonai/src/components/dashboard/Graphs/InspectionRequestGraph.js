...
import { Badge, TextField, Stack, Button, IconButton } from "@mui/material";
...
export const InspectionRequestGraph = ({
  ...
  const handleFilterClear = async () => {
    ...
    try {
      var res = await axios.post(
        url + "/Document/documentStatsMaterialIspectionFilter",
        {
...
export default InspectionRequestGraph;
