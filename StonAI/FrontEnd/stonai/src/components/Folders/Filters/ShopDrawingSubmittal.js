...
export default function ShopDrawingSubmittal({
  openAdvanceFilters,
  ...
  return (
    <Formik
      ...
      onSubmit={async (values) => {
        values.document_category = "Shop Drawing Submittals";
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          <Card className="mt-2">
            ...
            <div
              className="d-flex w-100 flex-wrap align-items-center py-0"
              style={{ gap: "0.5em", paddingInline: "10px" }}
            >
              <div
                className="fadein"
                style={{
                ...
                <>
                  ...
                  >
                    <Box className="filterWidth">
                      <TextField
                        error={Boolean(
                          touched.Comments_Box && errors.Comments_Box
                        )}
                        fullWidth
