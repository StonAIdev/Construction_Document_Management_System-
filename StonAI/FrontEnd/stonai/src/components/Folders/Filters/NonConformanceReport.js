  ...
  return (
    <Formik
      ...
      onSubmit={async (values) => {
        values.document_category = "Non Conformance Report";
        setFilters(values);
            ...
            >
              ...
              {isAdvanceFiltersOpen && <>
                ...
                >
                  <Box className="filterWidth">
                    <TextField
                      error={Boolean(touched.ATTACHEMENTS && errors.ATTACHEMENTS)}
                      fullWidth
                      helperText={touched.ATTACHEMENTS && errors.ATTACHEMENTS}
                      label="ATTACHEMENTS"
                      margin="normal"
                      name="ATTACHEMENTS"
                      onBlur={handleBlur}
                      onChange={handleChange}
                      value={values.ATTACHEMENTS}
                      variant="outlined"
                      size="small"
                      className="textfieldMargin"
                    />
