...
export default function MeterialInspectionRequest({
  openAdvanceFilters,
  ...
  const allDiscipline = ["Civil", "Arch", "Mech", "Elec", "MEQ", "others"];
  ...
  return (
    <Formik
      ...
      onSubmit={async (values) => {
        values.document_category = "Meterial Inspection Request";
        setFilters(values);
          ...
          <Card className="mt-2">
            <div className=" d-flex align-items-center" style={{ marginBottom: "10px" }}>
              <div style={{ marginBottom: "-20px" }}>
                <CardHeader
                  title="Meterial Inspection Request"
            ...
            >
              ...
              {isAdvanceFiltersOpen && <>
                ...
                >
                  <Box className="filterWidth">
                    <TextField
                      error={Boolean(touched.ISSUED_TO && errors.ISSUED_TO)}
                      fullWidth
                      helperText={touched.ISSUED_TO && errors.ISSUED_TO}
                      label="ISSUED TO"
                      margin="normal"
                      name="ISSUED_TO"
                      onBlur={handleBlur}
