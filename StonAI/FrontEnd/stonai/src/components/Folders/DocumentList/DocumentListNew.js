...
// import { url } from "../../../url";
// import { exportInfo } from "./ExportExcelInfo";
...
//   console.log("check doc permissions", currentComp);
//   const { enqueueSnackbar } = useSnackbar();
//   const handleClickVariant = (variant, title) => {
//     // variant could be success, error, warning, info, or default
//     enqueueSnackbar(title, { variant });
//   };
//   console.log("currentCompMArt", category);
...
//       console.log("BackFromDocRan");
//       console.log("backHistory.current", category);
//       // console.log("backHistory.current real", backHistory.current);
//       setCurrentComp(category);
//     } else {
//       console.log("BackFromDocRan");
//       console.log("backHistory.current real ", backHistory.current.currentComp);
//       console.log("backHistory.current", category);
//       setCurrentComp(backHistory.current.currentComp);
//       console.log("backHistory.current", currentComp);
...
//     try {
//       console.log("document_id", element.document_id);
//       const response = await axios(
//         "https://g0ajndudsk.execute-api.ap-south-1.amazonaws.com/default/getPresignedURLGetObject?fileName=" +
//           element.document_id +
//           element.name
...
//     console.log("to be deleted", documentIds);
...
//       console.log("CoverPageContext.coverPageOf", CoverPageContext.coverPageOf);
...
//     console.log("folder to move", folderToMove, selectedFile);
//     setLoading((isLoading = true));
...
//     console.log("This is chips");
//     console.log("row", row, "value", value, "direction", direction);
//   };
...
//     documentIds = rows;
//     console.log(documentIds, "document ids");

//     console.log(documentIds, "rows set");
//   }
//   var savedColumns;
//   useEffect(() => {
...
//   }, []);
//   console.log("catagory exist?", catagoryExists);
...
//           title: key,
//           field: `unMapped_field.Key_values[${key}]`,
...
//           filterCellStyle: MaterialFilterCellStyle(),
//         }));
//         console.log(newColumns, "new columns");

//         totalCounter = newColumns.length;
//         // console.log(nullCounter, "nullcounter 111");
...
//   //         field: `unMapped_field.${key}`, // Construct the field path
//   //         // ... other column properties
//   //       }));
//   //       console.log(newColumns, "temp columns 1 new");
//   //       // const newColumns = response.data.key?.map((key) => ({
//   //       //   "mapped_field?.SUBMITTAL_TITLE": {
//   //       //     title: "Submittal Title ",
//   //       //     field: "mapped_field?.SUBMITTAL_TITLE",
...
//   //       //   },
//   //       //   // title: key, // Use the key as the title
//   //       //   // field: `extractedFields.unMapped_field.${key}`, // Construct the field path
//   //       //   // ... other column properties
//   //       // }));

//   //       // Set your columns state or do whatever you need with newColumns
...
//   //       // e.g., show an error message or redirect the user
//   //     } else if (response.data.categoryExists === false) {
//   //       getColumns();
//   //     } else {
//   //     }
...
//   // Build columns configuration based on the keys
...
//       if (res.data.length) {
//         var tempcols = [];
//         var temsave = JSON.parse(res.data[0].columns);

//         temsave.forEach((element) => {
//           console.log("tempcol element.field", element.field);
//           var tempcol = defaultCloumns[element.field];
//           console.log("tempcol", tempcol);
//           tempcol.hidden = element.hidden;
//           tempcols.push(tempcol);
//         });
//         savedColumns = [...tempcols];
//       } else {
...
//       console.log("error", error);
//     }
//     // var savedColumns =  JSON.parse(localStorage.getItem('table1'));
//     var tempcolumns = [];
...
//   }
//   useEffect(() => {
//     console.log("check current", currentComp);
//     startFrom = 0;
//     totalPages = 0;
//     setPageNo(1);
//     getFiles();
...
//     console.log("file model", value, value.type);

//     // if (value.type === ".xls" || value.type === ".xlsx" || value.type === "application/vnd.ms-excel" || value.type === "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
//     //   console.log("here excel", value);

//     //   let response = await fetch(value.urls);
