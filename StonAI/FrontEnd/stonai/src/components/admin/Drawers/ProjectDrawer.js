            ...
            <Grid item xs={12}>
              <Formik
                initialValues={{
                  ...
                  sector_number: proj.sector_number,
                  area: proj.area,
                  city: proj.city,
                  county: proj.country,
                  specifyContractScope: proj.contract_scope,
                  specifyWorkScope: proj.work_scope,
                  country: proj.country,
                  project_type: proj.project_type,
                  contract_scope: proj.contract_scope,
                  work_scope: proj.work_scope,
