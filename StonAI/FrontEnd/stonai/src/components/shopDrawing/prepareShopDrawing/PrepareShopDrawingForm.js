...
const PrepareShopDrawingForm = ({
  ...
  return (
    <>
      <Helmet>
        <title>Prepare Shop Drawing Form | StonAi</title>
      </Helmet>
                      ...
                      <Grid container spacing={1}>
                        ...
                        <Grid item xs={12}>
                          <Typography
                            ...
                            color="text.secondary"
                          >
                            Select Shop Drawing from existing documents
                          </Typography>
                        </Grid>
                        <Grid item xs={12}>
                          <Typography
                        ...
                        >
                          <TextField
                            error={Boolean(
                              touched.MainContractor && errors.MainContractor
                            )}
                            fullWidth
                            helperText={
                              touched.MainContractor && errors.MainContractor
...
export default PrepareShopDrawingForm;
