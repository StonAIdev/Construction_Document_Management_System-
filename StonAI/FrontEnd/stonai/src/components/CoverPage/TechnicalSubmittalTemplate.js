...
const TechnicalSubmittalTemplate = ({ values }) => (
                ...
                <View style={[styles.section, { marginTop: "-10px" }]}>
                    <View style={styles.view}>
                        <View style={{ alignItems: "center", margin: "5px" }}>
                            <Text style={[styles.title, { marginBottom: "0px" }]}>TECHNICAL SUBMITTAL</Text>
                        </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={[styles.view, { width: "17%" }]}>
                <Text style={styles.baseText}>1</Text>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "20%" }]}>
                                <Text style={styles.baseText}>Cover</Text>
                            </View>
                            <View style={[styles.view, { width: "80%" }]}>
                                <Text style={styles.baseText}>{values?.cover}</Text>
                            </View>
                        </View>
                    ...
                    <View wrap={false} style={[styles.view, styles.sectionmargin]}>
                        <View style={{ flexDirection: "row", backgroundColor: "#ffff" }}>
                            ...
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "45%" }]}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "20%" }]}>
                                <Text style={styles.baseText}>Spec./ BOQ/ Drawing Ref</Text>
                            </View>
                            <View style={[styles.view, { width: "80%" }]}>
...
export default TechnicalSubmittalTemplate