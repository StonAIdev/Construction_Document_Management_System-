        ...
        <View style={[styles.section, { marginTop: "-10px" }]}>
          <View style={styles.view}>
            <View style={{ alignItems: "center", margin: "5px" }}>
              <Text style={[styles.title, { marginBottom: "0px" }]}>SHOP DRAWING SUBMITTAL:</Text>
            </View>
          ...
          <View wrap={false} style={[styles.view, styles.sectionmargin, { flexDirection: "row" }]}>
            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "50%" }]}>
              <View style={[{ flexDirection: "row" }]}>
                <Text style={styles.baseText}>Status</Text>
              </View>
            </View>
            <View style={[styles.view, { backgroundColor: "white", width: "50%" }]}>
              <View style={[{ flexDirection: "row" }]}>
                <Text style={styles.baseText}>status</Text>
              </View>
            </View>
