...
const NonConferenceRepTemplate = ({ values }) => (
    <Document>
                ...
                <View style={[styles.section, { marginTop: "-10px" }]}>
                    <View style={styles.view}>
                        <View style={{ alignItems: "center", margin: "5px" }}>
                            <Text style={[styles.title, { marginBottom: "0px" }]}>NON CONFORMANCE REPORT</Text>
                        </View>

                        <View style={{ width: "100%" }}>
                            <View style={{ alignItems: "center" }}>
                                <Text style={{ fontSize: "13px", marginBlock: "0px" }}>Project:</Text>
                            </View>
                        </View>
                    </View>
                ...
                <Text style={styles.baseText}>{values?.Issued_To}</Text>
                    ...
                    <View wrap={false}  style={[styles.view, styles.sectionmargin]}>
                        <View style={{ flexDirection: "row", backgroundColor: "#ffff" }}>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "25%" }]}>
                                <Text style={styles.baseText}>Drawing Reference</Text>
                            </View>
                            <View style={[styles.view, { width: "25%" }]}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "25%" }]}>
                                <Text style={styles.baseText}>Specs Reference</Text>
                            </View>
                            <View style={[styles.view, { width: "25%" }]}>
                                <Text style={styles.baseText}>{values?.Specs_Reference}</Text>
                            </View>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "25%" }]}>
                                <Text style={styles.baseText}>ITP/ Method Statement Ref</Text>
                            </View>
                            <View style={[styles.view, { width: "25%" }]}>
                                <Text style={styles.baseText}>{values?.Method_Statement} </Text>
                            </View>
                        </View>

                        <View style={{ flexDirection: "row", backgroundColor: "#ffff" }}>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "25%" }]}>
                                <Text style={styles.baseText}>Material Submittal Reference</Text>
                            </View>
                            <View style={[styles.view, { width: "25%" }]}>
                                <Text style={styles.baseText}>{values?.Material_Submittal_Reference} </Text>
                            </View>
                            <View style={[styles.view, { backgroundColor: "#d6d4d1", width: "25%" }]}>
                                <Text style={styles.baseText}>other Reference</Text>
                            </View>
                            <View style={[styles.view, { width: "25%" }]}>
                                <Text style={styles.baseText}> {values?.other_Reference}</Text>
                            </View>
                        </View>
                    ...
                    <View wrap={false}  style={[styles.view, styles.sectionmargin]}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            <View style={[styles.view, { width: "100%", height:"80px" }]}>
                                <Text style={styles.baseText}>
{values?.Causes_of_Non_Conformance}
                                </Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View wrap={false}  style={[styles.view, styles.sectionmargin]}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            <View style={[styles.view, { width: "100%", minHeight:"80px" }]}>
                                <Text style={styles.baseText}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={[styles.view, { width: "80%" }]}>
                ...
                {values?.sub_contractor_comments}
                    ...
                    <View wrap={false} style={[styles.view, styles.sectionmargin, { flexDirection: "column" }]}>
                        <View style={{ flexDirection: "row" }}>
...
export default NonConferenceRepTemplate;
